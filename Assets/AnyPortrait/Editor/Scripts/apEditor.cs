...
#region [미사용 코드] 19.8.18 Layout의 출력 여부를 결정하는 변수가 바뀌었다.
		...
		public void SaveEditorPref()
		{
			...
			EditorPrefs.SetBool("AnyPortrait_NeedToAskRemoveVertByPSDImport", _isNeedToAskRemoveVertByPSDImport);
