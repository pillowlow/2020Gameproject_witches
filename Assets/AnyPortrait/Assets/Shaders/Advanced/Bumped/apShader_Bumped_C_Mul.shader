...
Shader "AnyPortrait/Advanced/Bumped/Multiplicative Clipped"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			//o.Albedo = c.rgb * (o.Alpha) + float4(0.5f, 0.5f, 0.5f, 1.0f) * (1.0f - o.Alpha);//<<이전
			o.Albedo = c.rgb;//FinalColor에서 적용
