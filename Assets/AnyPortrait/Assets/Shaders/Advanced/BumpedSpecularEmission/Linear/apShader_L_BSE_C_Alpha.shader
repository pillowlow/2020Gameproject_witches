...
Shader "AnyPortrait/Advanced/Bumped Specular Emission/Linear/AlphaBlend Clipped"
{
	Properties
	{
	...
	SubShader
	{
		...
		half4 LightingSimpleColor(CustomSurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
		{
			...
			c.rgb = saturate(c.rgb + pow(s.Specular.rgb, 2.2f) * _LightColor0.rgb * max(0, (spec * atten)));
